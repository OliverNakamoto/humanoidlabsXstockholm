    ...
    def configure(self) -> None:
        with self.bus.torque_disabled():
            ...
            for motor in self.bus.motors:
                ...
                # Boost velocity limits for faster motion while keeping acceleration high
                try:
                    self.bus.write("Maximum_Velocity_Limit", motor, 254, normalize=False)
                except Exception:
                    # Some models/firmwares may not expose this register; ignore if unavailable
                    pass
